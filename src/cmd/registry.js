...
export const commandRegistry = {
    ...
    [COMMAND_NAMES.WR]: {
        ...
        description: "List and backfill canonical Work Records",
        summary: "List repo-local Work Record markdown and backfill records from completed Plans.",
        usage: [
            `${bin("wr")}`,
            `${bin("wr list")}`,
            `${bin("wr list --all")}`,
        ...
        notes: [
            ...
            "Use wr backfill to preview completed top-level Plans/Epics, link existing records by source Plan ID, and generate missing records after confirmation.",
            "Indexed search/read and manual create are deferred to later Work Records slices.",
        ],
