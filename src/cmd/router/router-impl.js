/**
 * @module cmd/router/router-impl
 * The core router logic extracted from the CLI command handler.
 */
 ...
 */
export async function runRouterCommandImpl(userRequest, images, uiAPI) {
