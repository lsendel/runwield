...
When a Plan enters execution, Harns captures a baseline git tree for the current worktree and uses that tree as the
...
unrelated user edits. This is a deliberate recovery trade-off until Harns supports isolated execution trees.
